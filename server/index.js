...
app.get(`/house/reps`, houseCtrl.getAllHouseReps)
app.get(`/house/vote/:houses_id`, houseCtrl.getHouseVoteById)
app.get(`/house/no/vote/:houses_id`, houseCtrl.housesNoVotesId)
